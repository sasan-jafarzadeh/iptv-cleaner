...
“https://iran.jafarzadeh-sasan-tru.workers.dev/playlist.m3u”,
...
```
    if is_hls:
        ...
        # برای stream های مستقیم (ts, mp4) HEAD کافیه
